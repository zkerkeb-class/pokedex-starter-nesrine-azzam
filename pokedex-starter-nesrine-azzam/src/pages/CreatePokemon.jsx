...
export default function CreatePokemon() {
  ...
  const [addToFavorites, setAddToFavorites] = useState(false); // ⭐ Nouvel état favori
  ...
  const handleSubmit = (e) => {
    ...
    createPokemon(formData)
      .then(() => {
        // ⭐ Ajouter aux favoris si coché
        if (addToFavorites) {
          const favorites = JSON.parse(localStorage.getItem('favorites')) || [];
          localStorage.setItem('favorites', JSON.stringify([...favorites, formData.id]));
        }
        navigate('/');
      })
